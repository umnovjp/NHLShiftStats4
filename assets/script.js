  ...
  fetch(requestURL, {"method": "GET", "headers": {}
    ...
    for (h=4;h<6;h++) { for (j=0;j<finalLineup2[h][2].length;j++) { if (!oldLines[h-4].includes(finalLineup2[h][2][j])) {newLines[h-4].push(finalLineup2[h][2][j])}}
      ...
      console.log('finalLineup3', finalLineup3);
                    ...
                    else if (finalLineup2[5][2].length<12) {lineByLine471.innerHTML=
                    lineByLine3(0,finalLineup2[4][2][6],finalLineup2[4][2][7],finalLineup2[4][2][8],finalLineup2[5][2][9],finalLineup2[5][2][10])[0][0]+' '+lineByLine3(0,finalLineup2[4][0][6],finalLineup2[4][0][7],finalLineup2[4][0][8],finalLineup2[5][0][9],finalLineup2[5][0][10])[0][1]+'<br>'
