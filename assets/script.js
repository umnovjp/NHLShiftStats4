  ...
  fetch(requestURL, {"method": "GET", "headers": {}
    ...
    for (h=4;h<6;h++) { for (j=0;j<finalLineup2[h][2].length;j++) { if (!oldLines[h-4].includes(finalLineup2[h][2][j])) {newLines[h-4].push(finalLineup2[h][2][j])}}
      ...
      console.log('finalLineup3', finalLineup3);
                    ...
                    +lineByLine2(finalLineup2[4][2][6],finalLineup2[4][2][7],finalLineup2[4][2][8],finalLineup2[5][2][6],finalLineup2[5][0][7],finalLineup2[5][0][8])[0][2]+' '+lineByLine2(finalLineup2[4][0][6],finalLineup2[4][0][7],finalLineup2[4][0][8],finalLineup2[5][0][6],finalLineup2[5][0][7],finalLineup2[5][0][8])[0][3]+'<br>'+
                  ...
                  {lineByLine571.innerHTML=
                   ...
                   // console.log(lineByLine2(finalLineup2[4][0][0],finalLineup2[4][0][1],finalLineup2[4][0][2],finalLineup2[5][0][0],finalLineup2[5][0][1],finalLineup2[5][0][2]))
                    ...
                    else if (finalLineup2[5][0].length<12) {lineByLine373.innerHTML=
