  ...
  fetch(requestURL, {"method": "GET", "headers": {}
    ...
    for (h=4;h<6;h++) { for (j=0;j<finalLineup2[h][2].length;j++) { if (!oldLines[h-4].includes(finalLineup2[h][2][j])) {newLines[h-4].push(finalLineup2[h][2][j])}}
      ...
      console.log('old', oldLines, 'new',  newLines);
                    ...
                    for (n=0;n<3;n++) { // n is 3 periods do not count OT or extra period in playoff game; l,m loops create an array player s q and r played together
                    ...
                    }} // end first m,l loop; shiftsLine2[0,1,2] are arrays q and r were on ice in 3 periods
                    // start second l,m loop calculating when q+r and s were on ice in 3 periods
                    ...
                    }} // end second away m,l loop; shiftsLine2[9,10,11] are arrays t and u and v were on ice in 3 periods for away team
                    shiftsLine2[12].push([]); // away team shiftsLine2[12] is array qrs played against tuv in each of 3 periods so called nested array
                    ...
                    lineVsLineTime=0; lineVsLineShifts=0; // calculating how many shifts and total time line qrs played against tuv assuming shift is >=10sec
                    ...
                    else if (finalLineup2[5][2].length<12) {lineByLine471.innerHTML=lineByLine3(0,finalLineup2[4][2][6],finalLineup2[4][2][7],finalLineup2[4][2][8],finalLineup2[5][2][9],finalLineup2[5][2][10])[0][0]+' '+lineByLine3(0,finalLineup2[4][2][6],finalLineup2[4][2][7],finalLineup2[4][2][8],finalLineup2[5][2][9],finalLineup2[5][2][10])[0][1]+'<br>'
                    ...
                    lineByLine553.innerHTML=lineByLine2(finalLineup2[4][0][9],finalLineup2[4][0][10],finalLineup2[4][0][11],finalLineup2[5][0][3],finalLineup2[5][0][4],finalLineup2[5][0][5])[0][0]+' '+lineByLine2(finalLineup2[4][0][9],finalLineup2[4][0][10],finalLineup2[4][0][11],finalLineup2[0][2][3],finalLineup2[5][0][4],finalLineup2[5][0][5])[0][1]+'<br>'
