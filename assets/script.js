  ...
  fetch(requestURL, {"method": "GET", "headers": {}
    ...
    for (h=4;h<6;h++) { for (j=0;j<finalLineup2[h][2].length;j++) { if (!oldLines[h-4].includes(finalLineup2[h][2][j])) {newLines[h-4].push(finalLineup2[h][2][j])}}
      ...
      console.log('finalLineup3', finalLineup3);
                    ...
                    else if (finalLineup2[5].length<12) {lineByLine171.innerHTML=lineByLine3(finalLineup2[4][2][0],finalLineup2[4][2][1],finalLineup2[4][2][2],finalLineup2[5][2][9],finalLineup2[5][2][10])[2][0]+' '+lineByLine3(finalLineup2[4][2][0],finalLineup2[4][2][1],finalLineup2[4][2][2],finalLineup2[5][2][9],finalLineup2[5][2][10])[2][1]+'<br>'
